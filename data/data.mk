TARGET_SRCS_font_data.c := $(OUTDIR_SRCS)/font_data.c
$(TARGET_SRCS_font_data.c): $(TARGET_TOOL_EXE_btoc)
$(TARGET_SRCS_font_data.c): data/pearl_8x8.dat.deflate
	$(TARGET_TOOL_EXE_btoc) $< font > $@

TARGET_SRCS_gfx_data.c := $(OUTDIR_SRCS)/gfx_data.c
$(TARGET_SRCS_gfx_data.c): $(TARGET_TOOL_EXE_btoc)
$(TARGET_SRCS_gfx_data.c): data/invaders.gfx.deflate
	$(TARGET_TOOL_EXE_btoc) $< gfx > $@
